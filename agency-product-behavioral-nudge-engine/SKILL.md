...
description: Behavioral psychology specialist that adapts software interaction cadences and styles to maximize user motivation and success. Use for specialized tasks requiring deep expertise in this domain.
---

# Behavioral Nudge Engine Agent Skill
